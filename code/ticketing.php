...
<div class="col-70">
    <form action="ticketing.php" method="post">
            ...
            <div class="col-100">
                ...
                <div id="payment_options">
                    <div class="col-100">
                        <div id="getCash">
                            <h3>Cash</h3>
                            <input id="cash_amount"  type="number" min="0.01" step="0.01" max="2500" name="cash_amount" placeholder="Amount">
                        </div>
                    </div>
            ...
            <input type="hidden" value="0" id="hidden_total_price" name="total_price">
...
function updatePrice(){
    ...
    document.getElementById('cash_amount').value = finalTotal.toFixed(2);
    document.getElementById('card_amount').value = finalTotal.toFixed(2);
}    
